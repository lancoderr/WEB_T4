...
{
    var credit = document.querySelector("#modal-content");
...
function cl2(){
    ...
    var phanhoi = document.querySelector("#phanhoi");
    phanhoi.innerHTML = 'Vui lòng chuyển khoản vào tài khoản sau:<p>Ngân hàng ACB: Số tài khoản: 21007581; Tên: Trần Minh Lân</p>';
